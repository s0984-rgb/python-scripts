...
parser.add_argument("-c", "--certificate_path", type=str, help="Path to the certificate to use for S3 endpoint", default="/etc/ssl/certs/ca-certificates.crt", required=False)
